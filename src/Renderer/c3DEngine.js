...
define('Renderer/c3DEngine', [
    ...
    'Core/Commander/Providers/MotreeProvider'
], function(
    THREE,
    OrbitControls,
    GlobeControls,
    ...
    function c3DEngine() {
        ...
        this.renderScene = function() {
            ...
            if(this.motreeProvider.getClipMap()){
                for(var i = 0; i < this.motreeProvider.getClipMap().length; i++)
                    this.motreeProvider.getClipMap()[i].update(this.camera.camera3D, this.renderer);
            }
